...
//        page_menus.showinit()
//        stackView_main.push(page_mainuser)
    }

    function movelocation(){
        console.log("moving. location");
        var curloc = supervisor.getcurLoc();
        if(curloc == supervisor.LOC_WAIT){
            pmoving.pos = "대기장소";
        }else if(curloc == supervisor.LOC_CHARGE){
            pmoving.pos = "충전기";
        }else{
            pmoving.pos = Number(curloc-supervisor.LOC_CHARGE) + "번 테이블";
        }
...
//    property string image_source: "file://" + applicationDirPath + "/image/map.png"
...
//                colorTools.y + 0 - 10
//            }else if(colorTools.paintColor == "#808080"){
//                colorTools.y + 80 - 10
//            }else{
//                colorTools.y + 160 - 10
//            }
...
//            id: canvas_map
//            x: 0; y:0;
//            width: 1235;//image_map.width
//            height: 1201;//image_map.height
//            antialiasing: true
